<?php
namespace my_inventory\myi_view_stock;
...
if (!is_user_logged_in()) {
    ...
    if ( isset($_POST['client_list']) && isset($_POST['access_request']) && $_POST['access_request'] == 'view_inventory' ) {
        ...
        $clients = $user_roles->get_clients( get_current_user_id(), 'view_inventory', $client_cd_allowed );
...
<div class="form-group"><pre class="no-display">
    <input type="hidden" name="access_request" id="access_request" value="view_inventory" />
